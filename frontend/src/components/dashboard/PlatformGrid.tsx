...
const PlatformGrid = () => {
  ...
  const [value, setValue] = React.useState<string | undefined>(
    isMobile ? undefined : "item-1"
  );

  React.useEffect(() => {
    setValue(isMobile ? undefined : "item-1");
  }, [isMobile]);
      ...
      >
        <AccordionItem value="item-1" className="border-none">
          <AccordionTrigger className="hover:no-underline">
            <h4 className="text-sm font-semibold">Plataformas Compatíveis</h4>
          </AccordionTrigger>
              ...
              {platforms.map((platform, index) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <ShoppingCart
                        className={`w-4 h-4 ${platform.iconColor}`}
                      />
                    </div>
